...
```
📊 输出：
51602384 reads; of these:
  51602384 (100.00%) were paired; of these:
    1793139 (3.47%) aligned concordantly 0 times
    47460439 (91.97%) aligned concordantly exactly 1 time
    2348806 (4.55%) aligned concordantly >1 times
96.53% overall alignment rate
```

几个关键指标：

1. **总 reads 数（51,602,384）**：这是经过质控后进入比对的 reads 数，和上一篇 fastp 输出的 clean reads 数应该一致。
...
GM12878_rep1   51602384    1793139       47460439       2348806        96.53%
