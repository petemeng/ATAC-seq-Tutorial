...
- **Consensus peaks = 128,543**：与 ENCODE 公布的 GM12878/K562 ATAC-seq 数据规模一致
...
load("results/deseq2_results.RData")   # 假设保存了 dds 对象
...
res_df <- read_csv("results/deseq2_all_results.csv")
