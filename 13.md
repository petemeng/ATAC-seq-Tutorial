...
>>> 正在处理 GM12878_rep1 ...
  总 reads: 31,755,587
  NFR (<150bp): 16,818,954 (52.9%)
  Mono-nuc (150-300bp): 14,936,633 (47.0%)

>>> 正在处理 GM12878_rep2 ...
  总 reads: 24,173,814
  NFR (<150bp): 12,237,008 (50.6%)
  Mono-nuc (150-300bp): 11,936,806 (49.3%)

>>> 正在处理 K562_rep1 ...
  总 reads: 32,767,012
  NFR (<150bp): 14,814,652 (45.2%)
  Mono-nuc (150-300bp): 17,952,360 (54.7%)

>>> 正在处理 K562_rep2 ...
  总 reads: 29,710,868
  NFR (<150bp): 12,655,243 (42.5%)
  Mono-nuc (150-300bp): 17,055,625 (57.3%)
```

这里有几个值得关注的模式：

- **GM12878 的 NFR:Mono 比值 > 1.0**（rep1=1.13，rep2=1.03），NFR reads 占比 ~51–53%，表明整体染色质更开放，无核小体区域的信号相对更丰富
- **K562 的 NFR:Mono 比值 < 1.0**（rep1=0.82，rep2=0.74），NFR reads 占比 ~43–45%，核小体占据区域的 reads 相对更多
- 这一差异与我们在前面几篇中看到的生物学一致：GM12878 作为 B 淋巴母细胞系可能具有更多全局可及的染色质区域
- 两种细胞类型都展现了 ATAC-seq 特征性的片段大小分布，具有清晰的 sub-nucleosomal 和 mono-nucleosomal 峰
